    ...
    <div className="coursePage-wrapper">
      ...
      <section id="description" className="coursePage-description">
        ...
        <p className="para12">
          ...
          Experience (UX) design, the art of creating
          <br /> products and services that are intuitive, enjoyable, and
          user-friendly. Gain a solid foundation in UX principles<br></br> and
          learn to apply them in real-world scenarios through engaging modules
        ...
        <p className="para12">
          ...
          <br /> continuous learning. Upon successful completion of our courses,
          you will earn a prestigious certification that
          <br /> not only validates your expertise but also opens doors to new
      ...
      <section id="instructor" className="coursePage-instructor">
        ...
        <p className="coursePage-instructor-bio">
          ...
          practical knowledge to the classroom. He
          <br /> has played a pivotal role in designing user-centric interfaces
          for renowned tech companies, ensuring seamless
          <br /> and engaging user experiences.
        </p>
      </section>
